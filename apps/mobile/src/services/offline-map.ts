...
// v2 prevents a completed pack created with the temporary CARTO raster style
// from being mistaken for the restored OpenFreeMap Liberty pack.
export const MUMBAI_MAP_PACK_NAME = 'mumbai-operational-basemap-v2';
