...
const NAV: readonly { key: SectionKey; label: string; note: string }[] = [
  ...
  { key: 'campaigns', label: 'Campaigns', note: 'Compose + approve' },
  { key: 'wavepx', label: 'WavePX', note: 'Audio transmit + decode' },
...
function CampaignWorkspaceV2({ campaigns, incidents, records, perform }: { campaigns: Campaign[]; incidents: Incident[]; records: RegionalRecord[]; perform: (label: string, action: () => Promise<unknown>) => Promise<void> }) {
